<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea type="text" class="formulario__input" id="descripcion" name="descripcion" placeholder="Descripción Evento" rows="8"><?php echo $evento->descripcion; ?></textarea>
    </div>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" min="1" name="disponibles" class="formulario__input" id="disponibles" placeholder="Ej. 20" value="<?php echo $evento->disponibles; ?>">
    </div>
