<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="ciudad" name="ciudad" placeholder="Ciudad de Ponente" value="<?php echo $ponente->ciudad ?? ""; ?>">
    </div>

    <div class="formulario__campo">
        <label for="pais" class="formulario__label">País</label>
        <input type="text" class="formulario__input" id="pais" name="pais" placeholder="País de Ponente" value="<?php echo $ponente->pais ?? ""; ?>">
    </div>

    <div class="formulario__campo">
        <label class="formulario__label">Imagen</label>
        <input type="file" class="formulario__input formulario__input--file" id="imagen" name="imagen" accept="image/*>
    </div>
